...
#   curl -fsSL https://raw.githubusercontent.com/marmikshah/atelier/master/tools/install.sh | sh -s -- uninstall
...
#
# Environment:
#   ATELIER_VERSION      release tag to install (for example v0.1.0)
